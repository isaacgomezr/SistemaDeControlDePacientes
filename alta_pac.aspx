<%@ Page Title="" Language="VB" MasterPageFile="~/MasterDefault.master" AutoEventWireup="false" CodeFile="alta_pac.aspx.vb" Inherits="alta_pac" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/css/bootstrap-datetimepicker-standalone.css" integrity="sha512-2e0Kl/wKgOUm/I722SOPMtmphkIjECJFpJrTRRyL8gjJSJIP2VofmEbqyApMaMfFhU727K3voz0e5EgE3Zf2Dg==" crossorigin="anonymous" />
    ...
    <div class="  ">
        <p class="h4 mb-4">Alta de pacientes</p>
        <p class="h5 mb-4">Datos personales</p>

        <div class="form-row mb-4">
            <div class="col">
                <!-- First name -->
                <asp:TextBox runat="server" ID="txt_nombre" class="form-control" placeholder="Nombre" required="true" AutoComplete="off" />
            </div>
            <div class="col">
                <!-- Last name -->
                <asp:TextBox runat="server" ID="txt_apellidos" class="form-control" placeholder="Apellidos" required="true" AutoComplete="off" />
            </div>
        </div>
        ...
        <!-- Sign up button -->
        <asp:Button class="btn btn-info my-4 btn-block" ID="registrar" Text="Registrar" runat="server" />
